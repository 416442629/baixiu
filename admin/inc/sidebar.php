...
<div class="aside">
    ...
    <ul class="nav">
      ...
      <?php $menuPosts_array = array('posts','post-add','categories'); ?>
      <li <?php echo in_array($current_page, $menuPosts_array) ? 'class = active' : '' ?>>

        
        <a href="#menu-posts" <?php echo in_array($current_page, $menuPosts_array) ? '' : 'class="collapsed"'?> data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>

        

        <ul id="menu-posts" class = "collapse<?php echo in_array($current_page, $menuPosts_array) ? ' in' :''?>">
      ...
      <?php $navMenu_array = array('nav-menus' ,'slides','settings' ); ?>
      <li <?php echo in_array($current_page, $navMenu_array) ? 'class = active' : '' ?>>
        <a href="#menu-settings" <?php echo in_array($current_page, $navMenu_array) ? '' : 'class="collapsed"'?> data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        
        <ul id="menu-settings" class = "collapse<?php echo in_array($current_page, $navMenu_array) ? ' in' : '' ?>">
